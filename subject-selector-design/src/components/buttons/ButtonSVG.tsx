...
export const ButtonSVG: FC<ButtonSVGProps> = ({
  ...
  var viewBoxPrams = `0 0 ${width?.toString()} 28`
  var display: React.SVGProps<SVGAElement> = <svg width={width?.toString()} height="28" viewBox={viewBoxPrams} xmlns="http://www.w3.org/2000/svg">
  ...
  //}
  //var reduceWidth:string = ({n}).toString();
