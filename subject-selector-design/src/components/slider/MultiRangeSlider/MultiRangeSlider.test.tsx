...
it('Renders with a className equal to the variant', () => {
    ...
    //expect(container.firstChild).contains('componentSlider-Typed') 
    expect(container.outerHTML).toContain('componentSlider-Typed') 
})
...
//     expect(container.firstChild.classList.contains('componentSlider-Typed')).toBe(true)
//     // const textElement = getByText(content);
//     // expect(textElement.classList).toContain("componentSlider-Typed");
