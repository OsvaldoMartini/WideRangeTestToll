...
{
    public class FollowingResolver : IValueResolver<UserMarca, AttendeeDto, bool>
    {
        ...
        public bool Resolve(UserMarca source, AttendeeDto destination, bool destMember, ResolutionContext context)
        {
